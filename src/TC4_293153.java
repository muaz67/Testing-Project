...
public class TC4_293153 { //Review Role
    ...
    public void testSearchPaper() throws InterruptedException {
      ...
      //Click on "details"
        WebElement createHereLink = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div[2]/p/a[1]")));
        createHereLink.click();
        Thread.sleep(1000);
    ...
    public void testDownloadNews() throws InterruptedException {
     ...
     // Enter email, password, and click "Remember Me"
        ...
        WebElement newsButton = driver.findElement(By.xpath("/html/body/div[2]/div[3]/ul/div/table/tbody/tr[4]/td[6]/a/button"));
        ...
        WebElement downloadButton = driver.findElement(By.xpath("/html/body/div[2]/div[3]/ul/div/div[1]/div/div/table/tbody/tr[4]/td/a/button"));
    ...
    public void testDeclinePaper() throws InterruptedException {
     ...
     // Click the "review” tab
        ...
        WebElement declineButton = driver.findElement(By.xpath("/html/body/div[3]/div[3]/div[2]/a[2]/button")).click();
    ...
    public void testSubmitPaper() throws InterruptedException {
     ...
     // Enter email, password, and click "Remember Me"
        ...
        WebElement submitButton = driver.findElement(By.xpath("/html/body/a/div[1]/form/div/div[5]/div[3]/button"));
